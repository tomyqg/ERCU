...
*
*
*                                  MC9S12 Metrowerks Banked Memory Model
*                                                 
*
* File         : OS_CPU_C.C
...
OS_STK *OSTaskStkInit (void (*task)(void *pd), void *p_arg, OS_STK *ptos, INT16U opt)
{
    ...
    *--stk = (INT16U)(0x1122);		        // Y  
    *--stk = (INT16U)(0x3344);		        // X  
    *--stk = (INT16U)0xBBAA;              // D Register D Register:A,B  
    ((INT8U*)stk)--;   
   	*stk = (INT8U)(0x80);	                // Save the PPAGE register CCR,16 bits in S12X	   //CCR,8 bits in S12
